	...
	<div id="wrap">
		...
		<div class="searchList">
			<div class="searchListImg">
				<a href="" id="show"><img src="./search_icon/detailSearch.ico" alt="detailSearch" width="35" height="35"> 
				<span class="searchListP">상세검색</span></a>
			</div>
		</div>
				...
				<c:forEach var="room" items="${roomList }">
					<div class="record">
						...
						<div class="room_info">
							...
							<div class="roomPrice">
								<span><fmt:formatNumber type="currency" value="${room.roomPrice}" currencySymbol="￦"/> KRW</span>
							</div>
				...
				<div class="detailSerach_sort">
                  ...
                  오름 차순 : ASC 내림차순 : DESC -->
					...
					<div class="sortButton">
						<div class="price-btn">
							<input type="radio" id="rowSort" name="fee" value="asc"checked="checked">
							<label for="rowSort" class="sort_label">낮은 가격 순</label>
						</div>
						<div class="price-btn">
